...
// Route pour récupérer une liste d'annonces, en fonction de filtres > sinon ensemble des annonces
...
router.put("/offer/update/:id", isAuthenticated, async (req, res) => {
  ...
  try {
    ...
    // Notifie Mongoose modification du tableau product_details
